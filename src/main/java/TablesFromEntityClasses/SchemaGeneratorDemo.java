...
public class SchemaGeneratorDemo {
	...
	public static void createDataBase(SchemaExport export, Metadata metadata) {
		EnumSet<TargetType> targetTypes = EnumSet.of(TargetType.DATABASE,TargetType.SCRIPT, TargetType.SCRIPT);
		SchemaExport.Action action = SchemaExport.Action.CREATE;
		export.execute(targetTypes, action, metadata);
		System.out.println("Export Okay!!");
	}
	
	public static void main(String [] args) {
		String configFileName = "hibernate_b.cfg.xml";
